#-*-coding: <utf-8>-*-
# Reino del gatodragon....
import random
import time


def introduccion():
    print("Estamos en una tierra llena de gatodragones. Delante nuestro,")
    print("se ven dos cuevas. En una cueva, el gatodragon es amigable")
    print("y compartira el tesoro contigo. El otro gatodragon")
...
def cheqcueva(CambiarCueva):
    ...
    time.sleep(2)
    print("Un gran gatodragon salta delante tuyo, abre su boca y...")
    print("")
    time.sleep(2)
    ...
    if CambiarCueva == str(FriendlyCueva):
        ...
        print("El gatodragon te come de un bocado....")
